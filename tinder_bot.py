...
class TinderBot():
    ...
    def auto_swipe(self):
        keywords = ["insta", "gramm", "@", "inzztagrm", "i n t s a", "snap", "igggg", "iggg", "igg", "smapp", "snepchat", "i n t s a", "s :", "ixnsta", "gram", "mys:", "s ;"]
        keywords = [keyword.lower() for keyword in keywords]  # Ensure keywords are in lowercase
